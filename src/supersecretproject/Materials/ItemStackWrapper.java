...
public class ItemStackWrapper implements Cloneable{
    ...
    public ItemStackWrapper(String name,ItemStack item) {
        this(item);
        setName(name);
    }
    ...
    public ItemStackWrapper setLore(String lore,ChatColor startColor)
    {
    ...
    public ItemStackWrapper addLore(String lore){
        // Added multiline lore support
        // Splits the lines
        String[] loreLines = lore.split("\n");
        itemLore.addAll(Arrays.asList(loreLines));
    ...
    public ItemStackWrapper addLore(String lore,ChatColor startColor){
        StringBuilder newLore = new StringBuilder();
        // Added multiline lore support
        // Splits the lines
        String[] loreLines = lore.split("\n");
    ...
    public ItemStackWrapper addLoreAtLine(String lore, int line){
        // Added multiline lore support
        // Splits the lines
        String[] loreLines = lore.split("\n");
        // Add each line
    ...
    public ItemStackWrapper addLoreAtLine(String lore, int line, ChatColor startColor){
        StringBuilder newLore = new StringBuilder();
        // Added multiline lore support
        // Splits the lines
        String[] loreLines = lore.split("\n");
    ...
    public ItemStackWrapper setItemColor(int red, int green, int blue){    
        if (!hasDisplay())
        {
            this.addDisplay();
        }
    ...
    public ItemStackWrapper clone(){
        return new ItemStackWrapper(getItemStack().clone());
    }
}
